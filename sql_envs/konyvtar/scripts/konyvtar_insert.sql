insert into konyv values(1116152201, 'Tíz kicsi néger', '9789630788984', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2010', 'YYYY'), 2090, 'krimi', 266);
insert into konyv values(1116152202, 'A váratlan vendég', '9789635490479', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2004', 'YYYY'), 1406, 'krimi', 200);
insert into konyv values(1116152203, 'És eljõ a halál...', '9789630786430', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2007', 'YYYY'), 1900, 'krimi', 292);
insert into konyv values(1116152204, 'Tûzvarázs', '9789639300347', 'FABYEN KIADÓ', to_date('2010', 'YYYY'), 1836, 'krimi', 488);
insert into konyv values(1116152205, 'A bankár', '9789632544137', 'ULPIUS-HÁZ KÖNYVKIADÓ KFT.', to_date('2011.09.22', 'YYYY.MM.DD'), 2799, 'krimi', null);
insert into konyv values(1116152206, 'Vészbejárat', '9789639300279', 'Fabyen Kiadó', to_date('2008', 'YYYY'), 2095, 'krimi', 472);
insert into konyv values(1116152207, 'Ébredj velem!', '9639300200', 'Tóthágas Kiadó', to_date('2007', 'YYYY'), 1668, 'krimi', 490);
insert into konyv values(1116152208, 'Holtak könyvtára', '9789639973114', 'GEOPEN KÖNYVKIADÓ KFT.', to_date('2010', 'YYYY'), 3316, 'krimi', 400);
insert into konyv values(1116152209, 'A vád tanúja', '963841345X', 'Hunga-Print', to_date('1994', 'YYYY'), 3000, 'krimi', 254);
insert into konyv values(1116152210, 'A tûzgyújtó', '9789630786836', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2010', 'YYYY'), 3040, 'krimi', 520);
insert into konyv values(1116152211, 'Álomcsapda', '9630779501', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2006', 'YYYY'), 1870, 'sci-fi', 752);
insert into konyv values(1116152212, 'Hasznos holmik', '9630778246', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2005', 'YYYY'), 1683, 'horror', 720);
insert into konyv values(1116152213, 'Dolores', '9600781875', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2006', 'YYYY'), 2125, 'thriller', 264);
insert into konyv values(1116152214, 'Fagyos éden', '9789639828605', 'METROPOLIS MEDIA GROUP', to_date('2010', 'YYYY'), 3791, 'sci-fi', 460);
insert into konyv values(1116152215, 'Fény a horizonton', '9789639566873', 'CHERUBION KÖNYVKIADÓ ÉS SZOLG.', to_date('2010', 'YYYY'), 1753, 'sci-fi', 344);
insert into konyv values(1116152216, 'Fényözön', '9639346888', 'Cherubion Könyvkiadó', to_date('2003', 'YYYY'), 1444, 'sci-fi', 392);
insert into konyv values(1116152217, 'A vénusz óceánjai', '9637429174', 'Cédrus Kiadó', to_date('1992', 'YYYY'), 1036, 'sci-fi', 158);
insert into konyv values(1116152218, 'A biológia rövid története', '11111111111', 'Gondolat Kiadó', to_date('1972', 'YYYY'), 1200, 'természettudomány', 278);
insert into konyv values(1116152219, 'A Hold tragédiája', '22222222222', 'Kozmosz Könyvek', to_date('1979', 'YYYY'), 1500, 'szépirodalom', 310);
insert into konyv values(1116152220, 'Hazám, hazám, te mindenem', '9789632511993', 'SZALAY-PANNON-LITERATÚRA KFT.', to_date('2010', 'YYYY'), 2660, 'történelem', 128);
insert into konyv values(1116152221, 'Az Osztrák-Magyar Monarchia tengerészeti repülõi 1911-1918', '9789633275092', 'ZRÍNYI KIADÓ', to_date('2010', 'YYYY'), 4741, 'történelem', 112);
insert into konyv values(1116152222, 'A magyar királyi honvédség légvédelme 1920-1945', '9789633274989', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2010', 'YYYY'), 4741, 'történelem', 150);
insert into konyv values(1116152223, 'Napóleon', '9500274612', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2004.04.01', 'YYYY.MM.DD'), 2300, 'történelem', 653);
insert into konyv values(1116152224, 'Napóleon', '963280256X', 'Gondolat', to_date('1975', 'YYYY'), 1500, 'történelem', 783);
insert into konyv values(1116152225, 'A Föld enciklopédiája', '9789630961615', 'KOSSUTH KIADÓ ZRT.', to_date('2010', 'YYYY'), 9491, 'természettudomány', 608);
insert into konyv values(1116152226, 'Éjféltájt', '9789630786249', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2008', 'YYYY'), 1900, 'krimi', 272);
insert into konyv values(1116152227, 'Az élet erõpróbái', '9638227117', 'PARK KÖNYVKIADÓ KFT.', to_date('1994', 'YYYY'), 1701, 'természettudomány', 326);
insert into konyv values(1116152228, 'Az élõ bolygó - a föld mai arculata', '9635300077', 'PARK KÖNYVKIADÓ KFT.', to_date('1994', 'YYYY'), 2081, 'természettudomány', 324);
insert into konyv values(1116152229, 'Az elsõ édenkert', '9630267217', 'PARK KÖNYVKIADÓ KFT.', to_date('1989', 'YYYY'), 1200, 'természettudomány', 238);
insert into konyv values(1116152230, 'Az óceán', '9789639693456', 'Mérték Kiadó', to_date('2007', 'YYYY'), 11042, 'természettudomány', 512);
insert into konyv values(1116152231, 'Az univerzum', '963-967-800-7', 'IKAR Kiadó', to_date('2007', 'YYYY'), 11042, 'természettudomány', 512);
insert into konyv values(1116152232, 'A gyevi törvény - Tanulságos mesék, mondák Mátyás királyról', '9789639581197', 'NAGYKÖNYV KIADÓ', to_date('2010', 'YYYY'), 1511, 'mesekönyv', 48);
insert into konyv values(1116152233, 'A nagyhatalmú sündisznócska', '9789633468814', ' HOLNAP KIADÓ KFT.', to_date('2010', 'YYYY'), 1615, 'mesekönyv', 14);
insert into konyv values(1116152234, 'Aranykoporsó', '9789630779180', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2005', 'YYYY'), 808, 'szépirodalom', 472);
insert into konyv values(1116152235, '1848 - a magyar szabadságharcz 1848-49-ben', '9789630960519', 'KOSSUTH KIADÓ ZRT.', to_date('2009', 'YYYY'), 6641, 'történelem', 476);
insert into konyv values(1116152236, 'A kõszívû ember fiai', '9789636451004', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2006', 'YYYY'), 758, 'szépirodalom', 442);
insert into konyv values(1116152237, 'A .NET 4.0 és a Visual Studio 2010', '9789639863170', 'SZAK KIADÓ KFT.', to_date('2010', 'YYYY'), 8550, 'informatika', 572);
insert into konyv values(1116152238, 'Java-fejtörõk - Csapdák, buktatók és szélsõséges esetek', '9789639637702', 'KISKAPU KIADÓ', to_date('2010', 'YYYY'), 5220, 'informatika', 270);
insert into konyv values(1116152239, 'Az XML-kézikönyv', '9789639131712', 'EURÓPA KÖNYVKIADÓ KFT.', to_date('2005', 'YYYY'), 10260, 'informatika', 758);
insert into konyv values(1116152240, 'Java alapú webszolgáltatások - XML, SOAP, WSDL, UDDI', '9789639301047', 'KISKAPU KIADÓ', to_date('2002', 'YYYY'), 4741, 'informatika', 644);
insert into konyv values(1116152241, 'Refactoring - Kódjavítás újratervezéssel', '9639637130', 'Kiskapu Kiadó', to_date('2006', 'YYYY'), 5525, 'informatika', 372);
insert into konyv values(1116152242, 'Domain-Specific Languages', '9780321712943', 'Addison-Wesley Professional', to_date('2010.10.03', 'YYYY.MM.DD'), 8735, 'informatika', 640);
insert into konyv values(1116152243, 'Design Patterns: Elements of Reusable Object-Oriented Software', '9780201633610', 'Addison-Wesley Professional', to_date('1994.11.10', 'YYYY.MM.DD'), 5980, 'informatika', 416);
insert into konyv values(1116152244, 'Programtervezési minták - Újrahasznosítható elemek objektumközpontú programokhoz', '9639301779', 'Kiskapu - Addison-Wesley', to_date('2004', 'YYYY'), 5980, 'informatika', 421);

insert into konyv values(1116152245, 'Nostradamus', '9637905146', 'Média Kiadó', to_date('1991', 'YYYY'), 260, null, 362);
insert into konyv values(1116152246, 'A Biblia kódja', '9639069817', 'Vince Kiadó Kft.', to_date('1999', 'YYYY'), 1495, null, 239);
...
insert into konyv values(1116152249, 'Az õsi törvény', '55555555555', null, null, null, null, null);
insert into konyv values(1116152250, 'Liliom és oroszlán', '66666666666', null, null, null, null, null);
insert into konyv values(1116152251, 'Az országvesztõ', '77777777777', null, null, null, null, null);
commit;



insert into szerzo values(2005182601, 'Christie', 'Agatha', to_date('1890.09.15', 'YYYY.MM.DD'));
insert into szerzo values(2005182602, 'Frei', 'Tamás', to_date('1966.05.21', 'YYYY.MM.DD'));
insert into szerzo values(2005182603, 'Fable', 'Vavyan', to_date('1956.03.20', 'YYYY.MM.DD'));
insert into szerzo values(2005182604, 'Cooper', 'Glenn', null);
insert into szerzo values(2005182605, 'King', 'Stephen', to_date('1947.09.21', 'YYYY.MM.DD'));
insert into szerzo values(2005182606, 'Harrison', 'Harry', to_date('1925.03.12', 'YYYY.MM.DD'));
insert into szerzo values(2005182607, 'Nemes', 'István', null);
insert into szerzo values(2005182608, 'Asimov', 'Isaac', to_date('1920.01.02', 'YYYY.MM.DD'));
insert into szerzo values(2005182609, 'Géczi', 'Zoltán', null);
insert into szerzo values(2005182610, 'Kelemen', 'József', null);
insert into szerzo values(2005182611, 'Nemere', 'István', to_date('1944.11.08', 'YYYY.MM.DD'));
...
insert into szerzo values(2005182616, 'Castelot', 'André', to_date('1911.01.23', 'YYYY.MM.DD'));
insert into szerzo values(2005182617, 'Lefebvre', 'Georges', to_date('1874.08.06', 'YYYY.MM.DD'));
insert into szerzo values(2005182618, 'Allaby', 'Michael', to_date('1933', 'YYYY'));
insert into szerzo values(2005182619, 'Dr. Coenraads', 'Robert R.', null);
insert into szerzo values(2005182620, 'Hutchinson', 'Robert', to_date('1957.11.12', 'YYYY.MM.DD'));
...
insert into szerzo values(2005182624, 'Attenborough', 'David', to_date('1926.05.8', 'YYYY.MM.DD'));
insert into szerzo values(2005182625, 'Sparks', 'John', to_date('1943', 'YYYY'));
...
insert into szerzo values(2005182629, 'Dinwiddie', 'Robert', to_date('1963.07.27', 'YYYY.MM.DD'));
insert into szerzo values(2005182630, 'Dipper', 'Frances', null);
insert into szerzo values(2005182631, 'Eales', 'Philip', to_date('1970', 'YYYY'));
...
insert into szerzo values(2005182635, 'Cousteau', 'Fabien', to_date('1890.09.15', 'YYYY.MM.DD'));
...
insert into szerzo values(2005182644, 'Jókai', 'Mór', to_date('1825.02.18', 'YYYY.MM.DD'));
insert into szerzo values(2005182645, 'Móra', 'Ferenc', to_date('1879.07.19', 'YYYY.MM.DD'));
...
insert into szerzo values(2005182654, 'Fowler', 'Martin', to_date('1963', 'YYYY'));
insert into szerzo values(2005182655, 'Gamma', 'Erich', to_date('1961', 'YYYY'));
...
insert into szerzo values(2005182660, 'Druon', 'Maurice', to_date('1918.04.23', 'YYYY.MM.DD'));
commit;
...
set ertek = (
    select nvl(konyv.ar, 1000) - to_number(substr(konyvtari_konyv.leltari_szam, -1, 1)) * 5.3
    from konyv
...
--insert into konyvtari_konyv values('FSZEK/1116152252-1', null, 11654);
--insert into konyvtari_konyv values('FSZEK/1116152252-2', null, 638);
--insert into konyvtari_konyv values('FSZEK/1116152253-1', null, 862);
--insert into konyvtari_konyv values('FSZEK/1116152270-1', null, 8528);
--insert into konyvtari_konyv values('FSZEK/1116152270-2', null, 2286);
--insert into konyvtari_konyv values('FSZEK/1116152270-3', null, 1287);
--insert into konyvtari_konyv values('FSZEK/11161522101-1', null, 8275);
--insert into konyvtari_konyv values('FSZEK/11161522100-1', null, 3621);
--insert into konyvtari_konyv values('FSZEK/11161522102-1', null, 1425);
--insert into konyvtari_konyv values('FSZEK/11161522100-2', null, 6325);
commit;



----diák, felnõtt, nyugdíjas, gyerek, törzstag, kedvezményezett----
insert into tag values('SZE-2010/151020-01', 'Ácsi', 'Milán', null, 'f', '4032 Debrecen, Budapesti út 3.', null, null, 'diák');
insert into tag values('SZE-2010/151020-02', 'Agyalá', 'Gyula', null, 'f', '1012 Budapest, Debreceni utca 43.', null, null, 'felnõtt');
insert into tag values('SZE-2010/151020-03', 'Alle', 'Glória', null, 'n', '4062 Debrecen, Szegedi körút 12.', null, null, 'felnõtt');
insert into tag values('SZE-2010/151020-04', 'Aloe', 'Vera', null, 'n', '4032 Debrecen, Gyõri út 26.', null, null, 'nyugdíjas');
...
insert into tag values('SZE-2010/151020-17', 'Cserepes', 'Virág', null, 'n', '4032 Debrecen, Budapesti út 6/5.', null, null, 'felnõtt');
insert into tag values('SZE-2010/151020-18', 'Ebéd', 'Elek', null, 'f', '3032 Miskolc, Debreceni út 3.', null, null, 'felnõtt');
...
insert into tag values('SZE-2010/151020-26', 'Kalim', 'Pál', null, 'f', '5002 Szolnok, Kétpói sugárút 18.', null, null, 'felnõtt');
insert into tag values('SZE-2010/151020-27', 'Kamu', 'Zoltán', null, 'f', '7667 Pécs, Budapesti út 23.', null, null, 'felnõtt');
insert into tag values('SZE-2010/151020-28', 'Karam', 'Ella', null, 'n', '7676 Pécs, Szombathelyi sétány 17.', null, null, 'törzstag');
insert into tag values('SZE-2010/151020-29', 'Kasza', 'Blanka', null, 'n', '7608 Pécs, Kaposvári dûlõ 8.', null, null, 'felnõtt');
insert into tag values('SZE-2010/151020-30', 'Kispál', 'Inka', null, 'n', '7400 Kaposvár, Székesfehérvári út 6.', null, null, 'nyugdíjas');
insert into tag values('SZE-2010/151020-31', 'Lepi', 'Pál', null, 'f', '8012 Székesfehérvár, Budapesti út 55.', null, null, 'felnõtt');
insert into tag values('SZE-2010/151020-32', 'Luc', 'Erna', null, 'n', '8000 Székesfehérvár, Balatoni sétány 53.', null, null, 'diák');
insert into tag values('SZE-2010/151020-33', 'Madag', 'Oszkár', null, 'f', '9700 Szombathely, Soproni köz 38.', null, null, 'felnõtt');
insert into tag values('SZE-2010/151020-34', 'Meg', 'Gyõzõ', null, 'f', '9700 Szombathely, Soproni köz 39/A.', null, null, 'felnõtt');
...
insert into tag values('SZE-2010/151020-38', 'Rabsz', 'Olga', null, 'n', '4625 Gyõröcske, Kossuth út 51.', null, null, 'nyugdíjas');
insert into tag values('SZE-2010/151020-39', 'Rúgka', 'Pál', null, 'f', '9012 Gyõr, Ausztriai út 2.', null, null, 'nyugdíjas');
insert into tag values('SZE-2010/151020-40', 'Szuper', 'Áron', null, 'f', '9022 Gyõr, Gyõröcskei dûlõ 14.', null, null, 'nyugdíjas');
insert into tag values('SZE-2010/151020-41', 'Szájbaverj', 'Elek', null, 'f', '9032 Gyõr, Debrecen-budapesti sétány 74.', null, null, 'diák');
...
insert into tag values('SZE-2010/151020-49', 'Vak', 'Ond', null, 'f', '9200 Mosonmagyaróvár, Vári dûlõ 88.', null, null, 'kedvezményezett');

update tag
set szuletesi_datum = add_months((sysdate - ((decode(besorolas,
                                                     'diák', 7,
                                                     'felnõtt', 25,
                                                     'nyugdíjas', 62,
                                                     'gyerek', 0,
                                                     'törzstag', 35,
                                                     'kedvezményezett', 50) +
                                             to_number(substr(cim, 1, 1)) +
                                             to_number(substr(cim, 2, 1)) +
                                             to_number(substr(cim, 3, 1)) +
                                             to_number(substr(cim, 4, 1))) * 365) + 
                                             (to_number(substr(olvasojegyszam, -2, 1)) +
                                             to_number(substr(olvasojegyszam, -1, 1)))),
                                  to_char(ceil(trunc(to_number(substr(olvasojegyszam, -2, 2)), -1) / 10) - 1 +
                                  to_number(substr(olvasojegyszam, -1, 1))));
    
update tag
set beiratkozasi_datum = sysdate - dbms_random.value(0, (floor(sysdate - szuletesi_datum)));
    
update tag
set tagdij = decode(besorolas,
                    'diák', 1800,
                    'felnõtt', 3800,
                    'nyugdíjas', 1500,
                    'gyerek', 1000,
                    'törzstag', 800,
                    'kedvezményezett', 1200);
...
insert into kolcsonzes values('SZE-2010/151020-01', 'FSZEK/1116152201-1', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-01', 'FSZEK/1116152206-1', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-13', 'FSZEK/1116152227-1', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-34', 'FSZEK/1116152227-3', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-34', 'FSZEK/1116152229-2', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-34', 'FSZEK/1116152229-1', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-35', 'FSZEK/1116152236-1', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-35', 'FSZEK/1116152227-2', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-40', 'FSZEK/1116152236-2', (sysdate - 6), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-42', 'FSZEK/1116152236-3', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-49', 'FSZEK/1116152236-4', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-49', 'FSZEK/1116152236-5', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-49', 'FSZEK/1116152201-3', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-49', 'FSZEK/1116152202-4', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-49', 'FSZEK/1116152212-4', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-49', 'FSZEK/1116152202-5', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-03', 'FSZEK/1116152201-2', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-03', 'FSZEK/1116152224-1', (sysdate - dbms_random.value(1, 800)), null, null, null);
insert into kolcsonzes values('SZE-2010/151020-16', 'FSZEK/1116152226-2', (sysdate - dbms_random.value(1, 800)), null, null, null);

update kolcsonzes
set hany_napra = dbms_random.value(1, (floor(sysdate - kolcsonzesi_datum)));
update kolcsonzes
set visszahozasi_datum = decode(substr(tag_azon, -1, 1),
                                0, kolcsonzesi_datum + hany_napra,
                                2, kolcsonzesi_datum + hany_napra,
                                4, kolcsonzesi_datum + hany_napra,
                                6, kolcsonzesi_datum + hany_napra,
                                8, kolcsonzesi_datum + hany_napra,
                                3, kolcsonzesi_datum + hany_napra + dbms_random.value(1, 999),
                                6, kolcsonzesi_datum + hany_napra + dbms_random.value(1, 999),
                                9, kolcsonzesi_datum + hany_napra + dbms_random.value(1, 999));

insert into kolcsonzes values('SZE-2010/151020-01', 'FSZEK/1116152227-2', (sysdate - 24), 21, sysdate - 10, null);
